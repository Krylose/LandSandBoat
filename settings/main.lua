...
xi.settings.main =
{
    ...
    ENABLE_COP       = 0, -- Chains of Promathia
    ENABLE_TOAU      = 0, -- Treasures of Aht Urhgan
    ENABLE_WOTG      = 0, -- Wings of the Goddess
    ENABLE_ACP       = 0, -- A Crystaline Prophecy
    ENABLE_AMK       = 0, -- A Moogle Kupo d'Etat
    ENABLE_ASA       = 0, -- A Shantotto Ascension
    ENABLE_ABYSSEA   = 0, -- Vision/Scars/Heroes of Abyssea
    ENABLE_SOA       = 0, -- Seekers of Adoulin
    ENABLE_ROV       = 0, -- Rhapsodies of Vana'diel
    ENABLE_TVR       = 0, -- The Voracious Resurgence
    ...
    MAX_LEVEL                      = 75, -- Level max of the server, lowers the attainable cap by disabling Limit Break quests. Default 99
    ...
    TWO_HANDED_DEX_ACCURACY_MULTIPLIER         = 0.5, -- 0.75: 1 DEX = 0.75 Accuracy. This has been 0.5 and 0.75 in previous eras
    HAND_TO_HAND_DEX_ACCURACY_MULTIPLIER       = 0.5, -- 0.75: 1 DEX = 0.75 Accuracy. This has been 0.5 in previous eras.
    ONE_HAND_MAIN_HAND_DEX_ACCURACY_MULTIPLIER = 0.5, -- 0.75: 1 DEX = 0.75 Accuracy. This has been 0.5 in previous eras.
    ONE_HAND_OFF_HAND_DEX_ACCURACY_MULTIPLIER  = 0.5, -- 0.75: 1 DEX = 0.75 Accuracy. This has been 0.5 in previous eras.

    -- AGI:RACC ratio. Mobs are hardcoded to 0.5
    RANGED_AGI_ACCURACY_MULTIPLIER = 0.5, -- 0.75: 1 AGI = 0.75 Ranged Accuracy. This has been 0.5 in previous eras.

    -- VIT:DEF ratio. Applies to everything but mobs and charmed mobs. Those are hardcoded to 0.5.
    PLAYER_ALLIES_VIT_DEF_MULTIPLIER = 0.5, -- 1.5: 1 VIT = 1.5 DEF. This has been 0.5 in previous eras.

    USE_ADOULIN_WEAPON_SKILL_CHANGES = false, -- true/false. Change to toggle new Adoulin weapon skill damage calculations. Default true
    DISABLE_PARTY_EXP_PENALTY        = false, -- true/false.
    ENABLE_IMMUNOBREAK               = false, -- true/false. Allow/Disallow immunobreaks to happen. Default true
